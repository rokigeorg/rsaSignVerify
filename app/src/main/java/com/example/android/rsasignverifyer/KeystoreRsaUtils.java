...
//TODO genKeyPair
//TODO load Keypair
//TODO sign a byteArray
//TODO verifiy a byteArray
...
public class KeystoreRsaUtils {
    ...
    KeystoreRsaUtils(){
        mAlias = "SUPER_SAVE_Alias";
    }

    KeystoreRsaUtils(String alias){
        mAlias = alias;
    }
    ...
    public void createKeys(Context context) throws NoSuchProviderException,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            spec = new KeyPairGeneratorSpec.Builder(context)
                    ...
                    .setSerialNumber(BigInteger.valueOf(1837))
            ...
            spec = new KeyGenParameterSpec.Builder(mAlias, KeyProperties.PURPOSE_SIGN)
                    ...
                    .setCertificateSerialNumber(BigInteger.valueOf(1837))
     ...
     */
    public byte[] signData(byte[] inputByteArray) throws KeyStoreException,
     ...
     * @param signatureByteArray The signature provided for the data.
     * @return A boolean value telling you whether the signature is valid or not.
     */
    public boolean verifyData(byte[] input, byte[] signatureByteArray) throws KeyStoreException,
            CertificateException, NoSuchAlgorithmException, IOException,
            UnrecoverableEntryException, InvalidKeyException, SignatureException {

        byte[] data = input;
        byte[] signature = signatureByteArray;
